...
class TrainOptions():
    def __init__(self):
        ...
        train.add_argument(
            '--num_epochs', type=int, default=200, help='Total number of training epochs'
        )
        train.add_argument(
            '--regressor',
            type=str,
        ...
        train.add_argument(
            '--gt_train_weight', default=1., help='Weight for GT keypoints during training'
        )
        train.add_argument(
            '--eval_dataset',
            type=str,
        ...
        train.add_argument(
            '--single_dataset', default=False, action='store_true', help='Use a single dataset'
        )
        train.add_argument(
            '--single_dataname', type=str, default='h36m', help='Name of the single dataset.'
        )
